...
class CategoriesTest extends TestCase
{
    ...
    public function test_create_category_with_valid_data()
    {
        ...
        $response = $this->actingAs($this->getUser())->post(route('admin.categories.store'), $data);
    ...
    public function test_update_category_with_valid_data()
    {
        ...
        $response = $this->actingAs($this->getUser())->put(route('admin.categories.update', $category), ['name' => $category->name, 'parent_id' => $parent->id]);
    ...
    public function test_update_category_with_invalid_data()
    {
        ...
        $response = $this->actingAs($this->getUser())->put(route('admin.categories.update', $category), ['name' => 'incorrect data ', 'parent_id' => 'incorrect id']);
    ...
    public function test_remove_category()
    {
        ...
        $response = $this->actingAs($this->getUser())->delete(route('admin.categories.destroy', $category));
